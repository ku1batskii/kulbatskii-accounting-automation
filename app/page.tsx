  ...
  return (
    <main>
      ...
      <header className="hero" id="top">
        <div className="wrap hero-inner">
          ...
          <div className="hero-copy">
            <h1>Как увеличить клиентский портфель<br/>без пропорционального найма?<em>ИИ-автоматизация должна высвободить мощность, а не просто сократить часы.</em></h1>
            <p className="lead">30 бухгалтеров ведут учёт 300+ клиентских компаний и наш собственный. Стоимость команды известна; задача проекта — определить, какие процессы ограничивают её мощность и где автоматизация даст собственнику измеримый рост.</p>
          </div>
          <div className="hero-evidence" aria-label="Масштаб проблемы">
            ...
            <article><strong>×2–3</strong><span>проверяемый потенциал роста мощности без найма</span></article>
      ...
      <section className="section paper" id="problem">
        <div className="wrap">
          <div className="section-head"><span className="eyebrow">01 · ЧТО ПРОИСХОДИТ СЕЙЧАС</span><h2>ФОТ известен. <em>Резерв мощности — нет.</em></h2><p>Собственник видит стоимость бухгалтерии, но не видит, какие операции мешают той же команде обслуживать больше компаний с контролируемым качеством.</p></div>
          ...
          <div className="pain-conclusion"><p>Главная задача — определить, какую часть оплаченного времени можно превратить в дополнительную мощность с помощью стандартизации, интеграций и ИИ.</p><a href="#target">Перейти к выгоде собственника <span>→</span></a></div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="target-layout">
            <div className="target-shifts">
              <article><h3>Рост портфеля без пропорционального найма</h3><p>Высвобождённая мощность направляется на обслуживание новых компаний</p></article>
      ...
      <section className="section audit-product" id="audit">
        <div className="wrap">
          <div className="section-head"><span className="eyebrow">07 · ПРОДУКТ</span><h2>Аудит потенциала <em>автоматизации</em></h2><p>За восемь недель раскладываем известную стоимость команды по процессам и показываем, где ИИ-автоматизация способна дать собственнику дополнительную мощность и рост маржи.</p></div>
